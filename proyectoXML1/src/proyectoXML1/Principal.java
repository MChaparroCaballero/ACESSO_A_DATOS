...
public class Principal {
	...
	public static void main(String[] args) {
		...
		String fichero = "C:\\Users\\MariaChaparroCaballe\\eclipse-workspace\\EsquemaXml\\NewXMLSchema.xml";/**
																											 ...
																											 **/
		Document doc = null;
		/** variable donde almacenaremos el arbol dom del xml **/
		...
		try {
			...
			while (i != 4) {
				...
				switch (opcion) {/**Abrimos el menu principal**/
				
				/**
				 * dependiendo de la opcion o leer el archivo, guarda un nuevo videojeugo, busca
				 * o sale del menu principal
				 **/
				
				case 1:
					/**
					 * Llamamos al metodo leer para que nos muestre todos los videojeugos existentes
					 * en el xml
					 */
					leerXML(doc);
					break;
				...
				case 3:
					/**
					 * si lo que quiere es buscar videojuegos le ponemos un menu con las posibles
					 * consultas que puede hacer
					 **/

					String consulta;
					/** variable temporal donde almacenaremos la consulta elegida formalizada **/
					...
					int opt2 = sc.nextInt();
					/** variable temporal para almacenar la eleccion del menu de consultas **/

					switch (opt2) {
					/** abrimos menu de consulta **/
					
					
						case 1:
							/**
							 * si elige a uno cambia el valor de consulta a ese respectiva consulta y llama
							 * al metodo realizar consultaXpath pasandole la ruta del fichero xml y la
							 * consulta
							 **/
						...
						case 2:
							/**
							 * si elige 2 le pedimos el año especifico por scanner y cambia el valor de
							 * consulta a ese respectiva consulta y llama al metodo realizar consultaXpath
							 * pasandole la ruta del fichero xml y la consulta
							 **/
						...
						case 3:
							/**
							 * si elige 3 le pedimos el desarrollador especifico por scanner y cambia el
							 * valor de consulta a ese respectiva consulta y llama al metodo realizar
							 * consultaXpath pasandole la ruta del fichero xml y la consulta
							 **/
							sc.nextLine();
						...
						case 4:
							/**
							 * si elige 4, cambiamos el valor de consulta a ese respectiva consulta y llama
							 * al metodo realizar consultaXpath pasandole la ruta del fichero xml y la
							 * consulta
							 **/
					...
					break; /** cerramos el menu de consulta **/
			...
			e.printStackTrace();/** en caso de error mostramos el historial de excepciones **/

		}

	}

	/**Metodo para que nos muestre todos los datos de todos los videojuegos**/
	public static void leerXML(Document doc) {
		...
		for (int i = 0; i < nodelist.getLength(); i++) {
			...
			/** almacenamos el nodo individual en posicion i **/

			if (node.getNodeType() == Node.ELEMENT_NODE) {
				/**
				 * si el nodo es un elemento llama al metodo procesar_videojuego que es en ese
				 * metodo que accedemos al nodo texto de cada elemento
				 **/
	...
	private static String[] procesar_videojuego(
		...
		Node ntemp = null;/** variable temporal par almacenar nodos individuales **/
		...
		for (int i = 0; i < nodos.getLength(); i++) {
			ntemp = nodos.item(i);
			/** obtenemos el nodo en posicion i dentro de la lista de nodos **/
	...
	/** Metodo para añadir videojuegos **/
	...
	/** Metodo para guardar el archivo xml los nuevos videojuegos **/
	...
	public static void guardarXML(Document doc, String archivo) {
		...
		try {
			...
			StreamResult result = new StreamResult(
					new File(archivo));/** ruta de en que archivo vamos a meter el guardado **/
	...
	/** Metodo de consultas **/
	public static void realizarConsultaXPath(String doc1, String consulta) throws ParserConfigurationException {
		try {
			/** abrimos try **/
			...
			/**
			 * Carga el archivo XML en un objeto Document doc2 y le pasamos doc1 que es la
			 * ruta string del archivo xml
			 **/
			...
			/**
			 * Define la consulta XPath que va a ser la que le pasamos segun la opcion
			 * elegida en el menu de consulta
			 **/
